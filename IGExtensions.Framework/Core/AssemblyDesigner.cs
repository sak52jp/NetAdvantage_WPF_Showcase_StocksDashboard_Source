...
namespace IGExtensions.Framework
{
    ...
    public class AssemblyDesigner
    {
        ...
        public const string AssemblyCopyrightYear = "2013";
        public const string AssemblyCopyright = "Copyright © " + AssemblyCompanyName + " 2009 - " + AssemblyCopyrightYear;
        /// <summary>
        /// The major and minor build numbers of the assembly, e.g. 10.1
        /// </summary>
        public const string AssemblyMajorMinor = "13.2";
        /// <summary>
        /// The build number of the assembly, e.g. 20101
        /// </summary>
        public const string AssemblyBuild = "1000";
        /// <summary>
        /// The revision of the assembly.
        /// </summary>
        public const string AssemblyRevision = "2";
        /// <summary>
    ...
    public const string ProductTitleSuffix = "";
        ...
        public class AssemblyDesc
        {
            ...
            public const string GridExtensions = AssemblyDesigner.AssemblyProductPrefix + "XamGrid" + AssemblyDesigner.AssemblyProductSuffix;
