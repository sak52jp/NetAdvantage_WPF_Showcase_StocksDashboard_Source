...
namespace IGShowcase.FinanceDashboard.Views
{
    public partial class HeatmapView : IGExtensions.Framework.Controls.NavigationPage
    {
        ...
        private void OnNavigationPageLoaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                _vm.Description = Strings.Market_Description;
                _vm.SelectedIndustry = Strings.Company_Summary_Info;
                _vm.AddTreemapFilter(Strings.DataColumn_Change, "ChangeValue", -7, +7);
                _vm.AddTreemapFilter(Strings.DataColumn_P_E, "PEValue", -10, 40);
                _vm.AddTreemapFilter(Strings.DataColumn_ROE, "ROEValue", -10, 40);
                _vm.AddTreemapFilter(Strings.DataColumn_Div_Yield, "DivYieldValue", -10, 10);
                _vm.AddTreemapFilter(Strings.DataColumn_Price_to_Book, "PriceToBookValue", -15, +15);
                _vm.AddTreemapFilter(Strings.DataColumn_Net_Profit_Margin, "NetProfitMarginValue", -50, +50);
                _vm.AddTreemapFilter(Strings.DataColumn_Price_to_Free_Cash_Flow, "PriceToFreeCashFlowValue", -100, +100);
            }
